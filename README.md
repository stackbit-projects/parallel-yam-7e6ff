...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff7e6ffbfb7ba0017c3894e
...
To start editing your site, you can use the Sanity interface at https://parallel-yam-7e6ff.sanity.studio/.
...
Generated at `2021-01-08T05:01:14.753Z` by Stackbit version `0.3.42`.